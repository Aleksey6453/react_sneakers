  ...
  return (
    ...
    <div className="header">
        <Link to='/' style={{ textDecoration: 'none', color: 'black' }}>
          <div className="header_left w_100_pr"> 
        ...
        <ul className="header_right">
           <li onClick={props.onClickCart} className="icon flex_li cart">
                <svg fill="black" 
                     width="30px" 
                     height="30px" 
                     viewBox="0 0 32 32" 
                ...
                <span className="flex_li_half padding_l_10"> {totalPrice} $</span>
           </li>
          
           <li className="icon flex_li padding_l_30">
              <Link to='/user'>
                    <svg width="30px" 
                        height="30px" 
                        viewBox="0 -2 24 24" 
           ...
           <li className="icon padding_l_30 flex_li">
            <Link to='/favorites'>
                <svg width="30px" 
                        height="30px"
                        viewBox="0 -2 24 24" 
